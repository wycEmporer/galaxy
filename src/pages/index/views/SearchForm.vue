<template>
  <div class="search_form">
    ...
    <div class="search_form-tips">
      <div class="search_form-tip">
        <i class="s-icon s-icon-nike"></i>
        <span class="search_form-tip-text">
...
import { SET_CITY_TYPE, SET_DATE, SET_DATE_TYPE, SET_PASSENGER, CHANGE_TYPE, OPEN_PASSENGER, EXCHANGE_CITY } from '@/store/type';
